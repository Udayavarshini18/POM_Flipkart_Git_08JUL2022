...
public class SelectProductPage extends TestBase {
	...
	//By firstLaptopLoc= By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[2]/div/div/div/a/div[1]/div[1]/div/div/img");
	public boolean validateSelectProduct() {

		driver.findElement(firstLaptopLoc).click();
